...
<form id="remove-form" class="form-horizontal" method="post">
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (!$developmentMode) {
                ...
                $mail->Body = "Open this link to confirm the ownership of your email address: "."<a href=\"http://".$_SERVER['SERVER_NAME']."/removeVer.php?id=$string&email=$email\">Confirm</a><br><br>You can ignore this email if you did not request your account deletion @ timetablenotifier.com.";
                if ($mail->send()) {
